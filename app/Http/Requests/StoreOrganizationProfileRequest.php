...
class StoreOrganizationProfileRequest extends FormRequest
{
    ...
    {
        return [
            'first_nation' => 'required|string|max:255',
            'treaty' => 'required|integer',
            'tribal_council' => 'required|string|max:255',
            ...
            'on_reserve_membership' => 'required|integer',
            'off_reserve_membership' => 'required|integer',
            ...
            'existing_company' => 'required|string',
    ...
    {
        return [
            'first_nation.required' => 'The first nation field is required.',
            ...
            'treaty.required' => 'The treaty field is required.',
            'treaty.integer' => 'The treaty field must be an integer.',
            'tribal_council.required' => 'The tribal council field is required.',
            ...
            'physical_location.required' => 'The physical location field is required.',
            ...
            'election_date.required' => 'The election date field is required.',
            ...
            'existing_company.required' => 'The existing company field is required.',
